...
export function reduce(reducer: any, initialValue: any, input: any[]): Function {
...
export function prop(obj: Object, propName: keyof typeof obj): any | Function {
    if (arguments.length === 0) {
        return prop;
    }
    if (arguments.length === 1) {
        return function subFunction(subPropName: keyof typeof obj) {
            if (arguments.length === 0) {
                return subFunction;
            }
...
export const pipe: Pipe =  function(...functions: Function[]) { // :any 
    if (arguments.length === 0) {
        return pipe;
    }
    return function subFunction() {
